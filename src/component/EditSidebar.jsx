            ...
            <div className="sidebar-progress">
                {steps.map((s, index) => (
                    <div
                        ...
                        onClick={() => onStepChange(index)} // 🔑 allow navigation
                    ...
                    >
                        ...
                        {index < steps.length - 1 && (
                            <div
                                className={`vertical-line ${index < step ? "filled" : ""}`}
                            ></div>
                        )}
                    </div>
                ))}
